...
```
dotnet new rbfx-empty -n MyAwesomeGame
```
...
Visit the [Releases](https://github.com/rbfx/rbfx-csharp-empty/releases) section of your repository to verify that the release was created successfully.
...
Add new variable **ITCH_PROJECT**  to the itch.io project id like [rebelfork/rbfx-csharp-empty](https://rebelfork.itch.io/rbfx-csharp-empty)
